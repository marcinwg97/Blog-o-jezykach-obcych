<template>
    ...
    <div class="container">
<div class="pb-2"><button class="btn btn-success"><router-link style="color: white !important;" :to="{ name: 'admin-static-sites-create'}">Dodaj</router-link></button></div>
...
<tbody>
  ...
  axios.get('/api/static-sites?page=' + page).then(res=>{
       if(res.status==200){
         ...
         console.log(err)
            ...
            deleteStaticSite(id){
                ...
                axios.post('/api/static-site/delete/' + id)
                .then((response)=>{
